...
Since this was my first project using microcontrollers so i do not recommend anyone use it as an actual air purifier, not to mention the filter incrementing function is imaginary, but feel free to do as you wish.
